			...
			foreach ($Loc->OpeAct as $i => $ope) {
				switch ($ope) {
					...
					case 11:
						...
						break;
					case 12:
						if ($this->meth_Misc_ToStr($CurrVal) === $Loc->OpePrm[$i]) $CurrVal = '';
						break;
					case 13:
					...
					case 17:
						...
						break;
					case 18:
						$CurrVal = ($Loc->OpeUtf8) ? mb_convert_case($CurrVal, MB_CASE_TITLE, 'UTF-8') : ucwords(strtolower($CurrVal));
						break;
				}
			}
		}
					...
					for ($i = $LocR->FooterNbr; $i >= 1; $i--) {
						...
						if ($Src->RecNum === 1) {
							...
							if ($GrpDef->AddLastGrp) {
								...
								unset($brk_i);
								$brk_i = false; // independent breaking
							}
